...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mashumaro-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14224&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mashumaro-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mashumaro` can be installed with:

```
conda install mashumaro
```

It is possible to list all of the versions of `mashumaro` available on your platform with:
